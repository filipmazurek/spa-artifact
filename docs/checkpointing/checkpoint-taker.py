...
# TODO: put in your correct checkpoint files!!
                ...
                if num_cores == 2:
                    os.system(f'cp -r {checkpoint_dir}/cpt.2-core-checkpoint {output_dir}/cpt.2-core-checkpoint')
                elif num_cores == 4:
                    os.system(f'cp -r {checkpoint_dir}/cpt.4-core-checkpoint {output_dir}/cpt.4-core-checkpoint')
