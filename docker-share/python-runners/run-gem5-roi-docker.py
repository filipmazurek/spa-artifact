"""Python runner to start gem5 with the appropriate arguments
"""
...
gem5_executable = '/shared/gem5/build/X86/gem5-mesi.fast'
config_file = '/shared/gem5/configs/example/fs.py'
checkpoint_storage = '/shared/checkpoints/'
disk_images = '/shared/ubuntu-images/'

benchmarks = ['ferret'] #[ 'bodytrack', 'blackscholes', 'canneal', 'dedup', 'facesim', 'ferret', 'fluidanimate', 'freqmine', 'raytrace', 'streamcluster', 'swaptions']
input_sizes = ['simsmall'] #, 'simmedium', 'simlarge']
num_cores_list = [4]

results_dir_base = '/shared/run-results'
...
def find_run(goal_num):
    ...
    # This should be redone with division and modulus
    i = 0
    while True:
...
checkpoint_dir = os.path.join(checkpoint_storage, 'parsec-roi-' + str(num_cores) + '_core', benchmark, input_size)
