...
csv_files.append('../csv-results/ferret_3mb_l1miss1kround.csv')
csv_files.append('../csv-results/ferret_3mb_runtimeround.csv')
csv_files.append('../csv-results/ferret_3mb_l2miss1kround.csv')
csv_files.append('../csv-results/ferret_3mb_maxloadround.csv')
csv_files.append('../csv-results/ferret_3mb_tlbwritemiss1kround.csv')
...
for csv_file in csv_files:
    ...
    for i in range(trials):
        ...
        # Run bootstrap. Note that this may throw an error in case of degenerate data
